...
export const RECOMMENDATIONS: RecommendationMap = {
  Muskelaufbau: {
    "18-25": {
      focus: "eine solide Kraftbasis und saubere Technik",
    ...
    "26-33": {
      focus: "funktionelle Kraft und gezielten Muskelaufbau",
    ...
    "34-45": {
      focus:
        "funktionelle Kraft mit besonderem Fokus auf Stabilität",
      focus_short: "Funktionelle Kraft",
      justification:
    ...
    "46+": {
      focus:
        "gelenkschonenden Muskelaufbau mit Fokus auf Stabilität",
      focus_short: "Gelenkschonenden Muskelaufbau",
      justification:
  ...
  "Schmerzfrei & Gesund im Alltag": {
    "18-25": {
      focus:
        "eine Verbesserung von grundlegenden Bewegungsgewohnheiten und Körperwahrnehmung",
    ...
    "26-33": {
      focus: "funktionelle Beweglichkeit und stabile Grundlagen",
    ...
    "34-45": {
      focus: "Haltung, Beweglichkeit und gezielte Entlastung",
    ...
    "46+": {
      focus:
        "sanfte Beweglichkeit, Gleichgewicht und gelenkschonende Kräftigung",
  ...
  Gewichtsabnahme: {
    "18-25": {
      focus: "die Grundlagen der Ernährung und der Etablierung von aktiven Gewohnheiten",
    ...
    "26-33": {
      focus:
        "nachhaltige Gewohnheiten für Bewegung und Ernährung",
    ...
    "34-45": {
      focus:
        "nachhaltige Lebensgewohnheiten und gezielte Bewegung",
    ...
    "46+": {
      focus:
        "langfristige Lebensstiländerungen mit schonender Aktivität",
